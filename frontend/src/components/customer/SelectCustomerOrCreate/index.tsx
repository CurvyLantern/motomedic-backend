            ...
            <Stack>
              ...
              <Tabs.Panel value={selectPanel}>
                <Select
                  ...
                  data={customers}
                  value={selectedCustomer ? selectedCustomer.value : null}
                />
              </Tabs.Panel>
              <Tabs.Panel value={manualPanel}>
                <SimpleGrid
                  ...
                  <TextInput
                    ...
                    withAsterisk={userConfig.userName.required}
                  />
                  {/* number */}
                  <NumberInput
                    placeholder={userConfig.userPhone.ph}
                    label={userConfig.userPhone.label}
                    withAsterisk={userConfig.userPhone.required}
                    hideControls
                  />
                  {/* email */}
                  <TextInput
                    ...
                    withAsterisk={userConfig.userEmail.required}
                  />
                  {/* checkCustomer */}
                  <Select
                    placeholder={userConfig.checkCustomer.ph}
                    label={userConfig.checkCustomer.label}
                    withAsterisk={userConfig.checkCustomer.required}
                  ...
                  <Textarea
                    ...
                    withAsterisk={userConfig.userAddress.required}
                  />
                  <Stack>
                    {/* bikeInfo */}
                    <Textarea
                      ...
                      withAsterisk={userConfig.bikeInfo.required}
                    />
                  </Stack>
                </SimpleGrid>
              </Tabs.Panel>
