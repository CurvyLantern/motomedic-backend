...
export const CustomerSlice = createSlice({
  ...
  reducers: {
    ...
    addCustomerOrderService: (state, action: PayloadAction<OrderService>) => {
      if (!state.selectedCustomer) {
        return console.log(" customer is undefined ");
      }
      state.selectedCustomer.services.push(action.payload);
    },
    addCustomerOrderProduct: (state, action: PayloadAction<OrderService>) => {
      if (!state.selectedCustomer) {
        return console.log(" customer is undefined ");
      }
      state.selectedCustomer.products.push(action.payload);
    },
